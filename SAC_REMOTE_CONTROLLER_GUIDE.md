...
- Z: `[0.5, 1.5]` (训练空间: [0.3, 2.0]，起始高度 1.0m)

> ⚠️ **重要**: 无人机起始高度约 1.0m，建议目标 Z 值在 0.5-1.5m 范围内
> 
> ⚠️ 如果目标 Z < 1.0m (低于起始高度)，无人机需要先下降，可能移动较慢
...
**原因**: 目标高度低于起始高度（1.0m），无人机需要先下降。

**解决**: 使用与起始高度相近的目标（Z=0.8-1.2m）可获得最快响应。

## 🎯 最佳实践

1. **使用推荐高度**: Z=1.0m 与起始高度一致，响应最快
